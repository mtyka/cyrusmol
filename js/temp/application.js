...
define (['glmol01','context','jQuery','jQueryUI','jquery.jstree','jquery.hotkeys','jquery.cookie'], function(glmol01,JobDialogManager) {
		  var my = {}
		  ...
		  my.deleteTask = function(taskname) {
		      $.ajax({
		          type: "POST",
		  ...
		  my.deleteAllOperations = function(key) {
		      $.ajax({
		          type: "POST",
		  ...
		  my.updateOperationsView = function(op_parent_key, childnode) {
...
//						$('#diagram_list_container').append("<span>" + d.name + "</span>");
//					}
//				}
//			});
//		}
//		function createNewDiagram() {
//			$.post("/diagram/new", function(diagram) {
//				console.log(diagram);
//				var diagram_name = $('#diagram_name').val();
//				$('#diagram_name').val('');
//				var diagram_body = $('#diagram_container').find('iframe').contents().find('body');
//				diagram_body.find('#diagram_id_container').remove();
//				diagram_body.append("<input type='hidden' id='diagram_id_container' value='" + diagram._id + "' />");
//
//				$('#diagram_container').dialog("open");
//
//			});
//		}
//
...
//		}
		  ...
		  my.updateStructureList = function() {
		      $.ajax({
		          type: "GET",
		          url: "/structure/list",
		  ...
		  my.deleteAllStructures = function(key) {
		      $.ajax({
		          type: "POST",
